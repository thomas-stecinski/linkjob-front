import { Card, CardHeader, CardBody, Divider, Skeleton, Avatar, Chip, ScrollShadow } from "@nextui-org/react";
...
const ShowCV = () => {
    ...
    useEffect(() => {
      const fetchCV = async () => {
        try {
          const response = await fetch(`${BACKEND_URL}/api/cv/get-cv/${requestedUserid}`, {
            credentials: 'include',
          });
